...
let svg='<svg xmlns="http://www.w3.org/2000/svg" width="1160" height="740" viewBox="0 0 1160 740" role="img" aria-labelledby="title desc"><title id="title">Iuri Ribeiro</title><desc id="desc">ASCII portrait and terminal profile. Tech lead and engineering manager in e-commerce and AI. Contact: iuri.io.</desc><rect width="1160" height="740" rx="16" fill="#0B0B0C"/><rect x="1" y="1" width="1158" height="738" rx="15" fill="none" stroke="#303036"/><path d="M0 48H1160" stroke="#303036"/><g font-family="monospace" font-size="13" fill="#99999f"><text x="26" y="30">iuri1911 / README.md</text><text x="1040" y="30">bash</text></g>';
const ramp=' .:-=+*#%@';
